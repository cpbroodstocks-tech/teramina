...
import { useStyles } from "features/pond/modal-delete-pond/styles";
import ConfirmDelete from "components/confirm-delete";
import { useDeletePond } from "features/pond/queries";
import { useToastStore } from "store/toast.store";
import { useTranslation } from "react-i18next";

const ModalDeletePond = ({ data }) => {
  const { t } = useTranslation();
  const { setToast: toast } = useToastStore();
  const { mutateAsync } = useDeletePond();
...
export default ModalDeletePond;
